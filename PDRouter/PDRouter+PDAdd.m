...
- (void)registerEvents {
    ...
    [self on:@"/push" actionHandler:^(id  _Nullable sender, NSDictionary * _Nullable parameters) {
    ...
    [self on:@"/pushother" actionHandler:^(id  _Nullable sender, NSDictionary * _Nullable parameters) {
    ...
    [self on:@"/present" actionHandler:^(id  _Nullable sender, NSDictionary * _Nullable parameters) {
