...
- (void)registerEvents {
    ...
    [self on:@"/push" completionHandler:^(id  _Nullable target, NSDictionary * _Nullable parameters) {
    ...
    [self on:@"/pushother" completionHandler:^(id  _Nullable target, NSDictionary * _Nullable parameters) {
    ...
    [self on:@"/present" completionHandler:^(id  _Nullable target, NSDictionary * _Nullable parameters) {
